...
export interface ExternalSessionManagerConfig {
  ...
  url: string;          // Session manager URL
  hmac_secret?: string; // HMAC secret (returned by server after save)
...
// 'claude-acp': acp-ws-server + @agentclientprotocol/claude-agent-acp を使用 (ACP WebSocket)
