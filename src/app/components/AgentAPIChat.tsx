    ...
    <div className="flex flex-col h-full max-w-4xl mx-auto">
      ...
      <div className="bg-white border-b border-gray-200 p-4">
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-semibold text-gray-900">AgentAPI Chat</h1>
      ...
      <div className="bg-white border-t border-gray-200 p-4">
        <div className="flex space-x-4">
          ...
          <button
            ...
            className="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:bg-gray-300 disabled:cursor-not-allowed"
          >
